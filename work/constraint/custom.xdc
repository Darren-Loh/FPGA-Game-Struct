...
set_property IOSTANDARD LVCMOS33 [get_ports {buzz[0]}]
set_property PACKAGE_PIN C1 [get_ports {buzz[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {buzz[1]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {rgb_led[3]}]
